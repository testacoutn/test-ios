...
This CocoaPods library helps you perform calculation.
  ...
  spec.homepage     = "https://github.com/testacoutn/test-ios.git"
  ...
  spec.author             = { "chandrakant" => "ideagmal@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/testacoutn/test-ios.git", :tag => "#{spec.version}" }
